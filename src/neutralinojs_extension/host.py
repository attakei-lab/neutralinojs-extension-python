...
class Connection:
    ...
    def make_message(self, method: str, data: Payload | Any | None = None) -> Message:
...
@dataclass
class Payload:
    """Message body of custom event.

    This format is not used when host send to extension.
    Extension send to host using this format.

    https://neutralino.js.org/docs/how-to/extensions-overview#sending-a-message-from-the-extension-to-app
    """
